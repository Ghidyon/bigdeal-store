...
<div class="loader-wrapper">
  <div>
    <img src="<?=ROOT?>assets/images/loader.gif" alt="loader">
  </div>
</div>
<!-- loader end -->
                ...
                <div class="nav-left" >
                  ...
                  <div class="collapse  nav-desk" id="navbarToggleExternalContent">
                    <ul class="nav-cat title-font">
                      <li> <img src="<?=ROOT?>assets/images/layout-1/nav-img/01.png" alt="category-product"> <a href="#">western ware</a></li>
                      <li> <img src="<?=ROOT?>assets/images/layout-1/nav-img/02.png" alt="category-product"> <a href="#">TV, Appliances</a></li>
                      <li> <img src="<?=ROOT?>assets/images/layout-1/nav-img/03.png" alt="category-product"> <a href="#">Pets Products</a></li>
                      <li> <img src="<?=ROOT?>assets/images/layout-1/nav-img/04.png" alt="category-product"> <a href="#">Car, Motorbike</a></li>
                      <li> <img src="<?=ROOT?>assets/images/layout-1/nav-img/05.png" alt="category-product"> <a href="#">Industrial Products</a></li>
                      <li> <img src="<?=ROOT?>assets/images/layout-1/nav-img/06.png" alt="category-product"> <a href="#">Beauty, Health Products</a></li>
                      <li> <img src="<?=ROOT?>assets/images/layout-1/nav-img/07.png" alt="category-product"> <a href="#">Grocery Products </a></li>
                      <li> <img src="<?=ROOT?>assets/images/layout-1/nav-img/08.png" alt="category-product"> <a href="#">Sports</a></li>
                      <li> <img src="<?=ROOT?>assets/images/layout-1/nav-img/09.png" alt="category-product"> <a href="#">Bags, Luggage</a></li>
                      <li> <img src="<?=ROOT?>assets/images/layout-1/nav-img/10.png" alt="category-product"> <a href="#">Movies, Music </a></li>
                      <li> <img src="<?=ROOT?>assets/images/layout-1/nav-img/11.png" alt="category-product"> <a href="#">Video Games</a></li>
                      <li> <img src="<?=ROOT?>assets/images/layout-1/nav-img/12.png" alt="category-product"> <a href="#">Toys, Baby Products</a></li>
                      <li>
                        <ul class="mor-slide-open">
                          <li> <img src="<?=ROOT?>assets/images/layout-1/nav-img/08.png" alt="category-product"> <a>Sports</a></li>
                          <li> <img src="<?=ROOT?>assets/images/layout-1/nav-img/09.png" alt="category-product"> <a>Bags, Luggage</a></li>
                          <li> <img src="<?=ROOT?>assets/images/layout-1/nav-img/10.png" alt="category-product"> <a>Movies, Music </a></li>
                          <li> <img src="<?=ROOT?>assets/images/layout-1/nav-img/11.png" alt="category-product"> <a>Video Games</a></li>
                          <li> <img src="<?=ROOT?>assets/images/layout-1/nav-img/12.png" alt="category-product"> <a>Toys, Baby Products</a></li>
                        </ul>
                      </li>
                      <li>
                        ...
                        <li>
                          <div class="container">
                            ...
                            <div class="row menu-banner">
                              <div class="col-lg-6">
                                <div>
                                  <img src="<?=ROOT?>assets/images/menu-banner1.jpg" alt="menu-banner" class="img-fluid">
                                </div>
                              </div>
                              <div class="col-lg-6">
                                <div>
                                  <img src="<?=ROOT?>assets/images/menu-banner2.jpg" alt="menu-banner" class="img-fluid">
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="container">
                            <div class="row">
                              ...
                              <div class="col mega-box product ">
                                <div class="mega-img">
                                  <img src="<?=ROOT?>assets/images/mega-banner.jpg" alt="menu-banner" class="img-fluid">
                                </div>
                              </div>
                            </div>
                          </div>
            ...
            <div class="category-right">
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu gift-dropdown">
                  <div class="media">
                    <div  class="mr-3">
                      <img src="<?=ROOT?>assets/images/icon/1.png" alt="Generic placeholder image">
                    </div>
                    <div class="media-body">
                      <h5 class="mt-0">Billion Days</h5>
                      <p><img src="<?=ROOT?>assets/images/icon/currency.png" class="cash" alt="curancy"> Flat Rs. 270 Rewards</p>
                    </div>
                  </div>
                  <div class="media">
                    <div  class="mr-3">
                      <img src="<?=ROOT?>assets/images/icon/2.png" alt="Generic placeholder image" class="gift-bloc">
                    </div>
                    <div class="media-body">
                      <h5 class="mt-0">Fashion Discount</h5>
                      <p><img src="<?=ROOT?>assets/images/icon/fire.png"  class="fire" alt="fire">Extra 10% off (upto Rs. 10,000*) </p>
                    </div>
                  </div>
                  <div class="media">
                    <div  class="mr-3">
                      <img src="<?=ROOT?>assets/images/icon/3.png" alt="Generic placeholder image">
                    </div>
                    <div class="media-body">
                  ...
                  <div class="media">
                    <div  class="mr-3">
                      <img src="<?=ROOT?>assets/images/icon/6.png" alt="Generic placeholder image">
                    </div>
                    <div class="media-body">
                  ...
                  <div class="media">
                    <div  class="mr-3">
                      <img src="<?=ROOT?>assets/images/icon/5.png" alt="Generic placeholder image">
                    </div>
                    <div class="media-body">
